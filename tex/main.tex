...
\begin{figure}
    ...
    \caption{figure 10: realistic domain showing the snaps, inner cavity definitions . \red{add lat/lon lines as grid?}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{../make_figures/plots/figure12.eps}

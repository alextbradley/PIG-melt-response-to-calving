...
\begin{figure}
    ...
    \caption{figure 8: mean melt rate for P = 700 and P = 800. Decomposition for P = 800 runs }
    \label{fig:figure8}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.4\textwidth]{../make_figures/plots/figure9.eps}
    \caption{figure 9: meridional ridge cross sections for the $P$=800~m case (will be to the ridge c.f. figure 7 in JDR 2014 paper) }
    \label{fig:figure9}
\end{figure}
